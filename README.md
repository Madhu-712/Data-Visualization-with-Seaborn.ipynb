...
The arguments are same for both set_palette() and color_palette() functions, but the default Matplotlib parameters are changed so that the palette is used for all plots.
